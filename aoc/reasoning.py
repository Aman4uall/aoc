        ...
        if basis.process_template == ProcessTemplate.ETHYLENE_GLYCOL_INDIA:
            ...
            if self._product_key(basis) == "benzalkonium_chloride":
                markdown = (
                    ...
                    "on a sold-solution basis, taking the commercial 50 wt% formulation basis as the governing design reference for process selection, balances, utilities, and economics. "
                    "The selected configuration is built around a continuous quaternization route with a jacketed liquid reactor train, followed by volatile cleanup, purification, recycle handling, final formulation, storage, and dispatch sections suitable for an India-based specialty-chemical installation."
                    "\n\nThe process review begins with the chemistry and literature basis of benzalkonium chloride manufacture and narrows the practical alternatives to a quaternization-based liquid train that can be supported by the available public patent, safety, market, and India-siting evidence. "
                    "The preferred route is then translated into a plant-wide process structure comprising feed preparation, controlled quaternization, removal of volatile species, polishing and concentration, recycle recovery, formulation, storage, and dispatch. "
                    "This route is selected not merely because it is chemically feasible, but because it offers the best overall balance among industrial plausibility, operability, separation tractability, hazard control, and compatibility with the commercial sold-solution basis adopted for the present design."
                    "\n\nThe study selects Dahej-side siting logic because the location offers chemical-cluster infrastructure, utility access, logistics support, port connectivity, and a regulatory and industrial ecosystem that fits the proposed BAC plant better than a more isolated site basis. "
                    "The siting discussion is therefore not treated as a generic geography exercise; rather, it is tied directly to the proposed feed movement, utility demand, hazardous-material handling expectations, and likely operating-support requirements of a specialty chemical unit of this scale. "
                    "On this basis, the report carries the case through site selection, utility framing, layout logic, storage philosophy, and control-system planning in a manner consistent with Indian manufacturing conditions."
                    "\n\nFrom the design standpoint, the report develops the selected route through thermodynamic and kinetic admissibility checks, plant-wide material and energy balances, reactor sizing, separation-system design, equipment sizing, mechanical basis, utility demand, instrumentation strategy, HAZOP coverage, safety and environmental management, and layout development. "
                    "These chapters are intended to function together as an integrated preliminary design package rather than as isolated calculations. "
                    "Accordingly, the balances, design equations, equipment selections, utility loads, and financial consequences are all kept linked to the same route basis and the same commercial production target."
                    "\n\nAt the present level of detail, the main technical caution does not arise from the overall process concept itself, but from the expected limitations in purification thermodynamics, recycle-sensitive separation behavior, and some of the pseudo-component and impurity assumptions that remain necessary for BAC as a commercial homolog mixture. "
                    "These limitations are now surfaced explicitly in the report through the data-gap and estimation-method sections, so the reader can distinguish clearly between directly cited evidence, model-derived quantities, solver-derived balance closure, and unresolved or assumption-led items. "
                    "This is important because the present document is intended to be a strong preliminary-feasibility report, not an overclaimed detailed-design package."
                    "\n\nThe economic reading of the case remains favorable at the current level of definition, and the integrated assessment supports carrying the project forward into deeper engineering. "
                    "However, the next stage should focus on tightening the purification-property basis, strengthening impurity and recycle data, improving recovery-aware economic realism, and progressively replacing estimation-heavy sections with more direct design or commercial evidence. "
                    "Subject to those next-step improvements, the proposed benzalkonium chloride plant may be regarded as a technically coherent and commercially promising design case for further development."
                )
